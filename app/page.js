...
export default function Gallery() {
	...
	return (
		...
		>
			...
			{allImages && (
				<div
					className={`flex max-lg:min-h-screen max-lg:pt-20  w-full h-auto max-lg:px-2 lg:w-[1122px] lg:h-[650px] lg:flex-row flex-col overflow-hidden justify-start items-start transition-transform transform duration-300 ease-in-out ${
			...
			{showOverlay && (
				...
				>
					<div
						...
						className='flex justify-center items-center rounded-lg w-10 h-10 hover:cursor-pointer z-30 fixed right-16 top-16 text-primary-white hover:bg-primary-blue hover:bg-opacity-10'
					>
						<svg
							width='32'
							height='32'
