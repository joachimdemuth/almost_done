	...
	return (
		<div className='flex flex-col w-full min-h-screen justify-center items-center'>
			...
			<div className='flex min-w-full min-h-screen justify-center items-center z-10'>
				<svg
        overflow={"visible"}
					className=' w-72 h-auto lg:w-[1200px] lg:h-[800px]'
					viewBox='0 0 100 75'
					fill='none'
          ...
          <feTurbulence
			...
			<div className='z-10 flex fixed w-full justify-center items-center bottom-12'>
				<Link href='/main-hall'>
					<div className='flex justify-center items-center align-middle bg-slate-100  font-bold border-[#0057FF] lg:w-[150px] lg:h-[150px] w-[100px] h-[100px] px-4 py-4 text-center lg:text-lg text-md text-[#0057FF] rounded-full'>
						Go to gallery
					</div>
				</Link>
			</div>
